...
Releases follow Semantic Versioning (SemVer). Before creating a release, ensure all tests pass and the code is stable.

For detailed release procedures and internal guidelines, refer to the internal release documentation.
